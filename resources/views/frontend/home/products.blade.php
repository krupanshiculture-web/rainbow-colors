...
@section('content')
<main>
    <section class="banner-two" style="background: linear-gradient(90deg, rgba(0,0,0,.86), rgba(0,0,0,.3)), url('{{ asset('frontend/assets/images/banner/ad-banner1.jpg') }}') center/cover; min-height: 420px;"><div class="container"><div class="banner-two__content" style="padding: 125px 0;"><h1>Our <span class="primary-color">Products</span></h1><p>Vibrant colour. Thoughtful packaging. Ready for celebration.</p></div></div></section>
