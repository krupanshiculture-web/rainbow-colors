...
@section('content')
 ...
 <main>
        ...
        <section class="page-banner bg-image pt-130 pb-130" data-background="{{ asset('frontend/assets/images/banner/inner-banner.jpg') }}">
            <div class="container">
                                ...
                                <div class="swiper shop-single-slide">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/assets/images/shop/01.jpg') }}" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/assets/images/shop/02.jpg') }}" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/assets/images/shop/03.jpg') }}" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ asset('frontend/assets/images/shop/04.jpg') }}" alt="image">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="review" class="tab-pane fade">
                            <div class="review-wrp">
                                ...
                                <div class="abmin d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                    <div class="img pb-4 pb-md-0 me-4">
                                        <img src="{{ asset('frontend/assets/images/about/comment1.png') }}" alt="image">
                                    </div>
                                    <div class="content position-relative p-4 bor">
                                        <div class="head-wrp pb-1 d-flex flex-wrap justify-content-between">
                                            <a href="#0">
                                ...
                                <div class="abmin d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                    <div class="img pb-4 pb-md-0 me-4">
                                        <img src="{{ asset('frontend/assets/images/about/comment4.png') }}" alt="image">
                                    </div>
                                    <div class="content position-relative p-4 bor">
                                        <div class="head-wrp pb-1 d-flex flex-wrap justify-content-between">
                                            <a href="#0">
