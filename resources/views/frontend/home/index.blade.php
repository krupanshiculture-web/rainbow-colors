  ...
  <main>
        ...
        <section class="banner-two">
            <div class="banner-two__shape-left d-none d-lg-block wow bounceInLeft" data-wow-duration="1s"
                data-wow-delay=".5s">
                <img src="{{ asset('frontend/assets/images/shape/vape1.png') }}" alt="shape">
            </div>
            <div class="banner-two__shape-right d-none d-lg-block wow bounceInRight" data-wow-duration="1s"
                data-wow-delay=".1s">
                <img class="sway_Y__animation " src="{{ asset('frontend/assets/images/shape/vape2.png') }}" alt="shape">
            </div>
                    ...
                    <div class="swiper category__slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image1.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon1.png') }}" alt="icon">
                                        </div>
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image2.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon2.png') }}" alt="icon">
                                        </div>
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image3.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon3.png') }}" alt="icon">
                                        </div>
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image4.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon4.png') }}" alt="icon">
                                        </div>
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image5.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon5.png') }}" alt="icon">
                                        </div>
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="category__item category-two__item text-center">
                                    <a href="shop.html" class="category__image d-block">
                                        <img src="{{ asset('frontend/assets/images/category/category-image6.png') }}" alt="image">
                                        <div class="category-icon">
                                            <img src="{{ asset('frontend/assets/images/category/category-icon6.png') }}" alt="icon">
                                        </div>
                                    </a>
        ...
        <section class="discount-area bg-image" data-background="{{ asset('frontend/assets/images/bg/discount-bg2.jpg') }}">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="image mb-5 mb-lg-0"><img src="{{ asset('frontend/assets/images/discount/discount-image2.png') }}"
                                alt="image"></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="discount__item ps-0 pb-5 pb-lg-0 ps-lg-5">
                            <div class="section-header">
                                ...
                                <a class="off-btn wow fadeInUp" data-wow-delay=".4s" href="#0"><img class="mr-10"
                                        src="{{ asset('frontend/assets/images/icon/fire.svg') }}" alt="icon"> GET <span
        ...
        <section class="get-now-area pt-130 pb-130">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6">
                        <h4 class="mb-30 wow fadeInUp" data-wow-delay=".1s"><img src="{{ asset('frontend/assets/images/icon/fire.svg') }}"
                                alt="icon">
                    ...
                    <div class="col-xl-6">
                        <div class="get-now__image mt-5 mt-xl-0">
                            <div class="get-bg-image">
                                <img src="{{ asset('frontend/assets/images/shop/get-bg.png') }}" alt="image">
                            </div>
                            <div class="swiper get__slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image">
                                            <img src="{{ asset('frontend/assets/images/shop/get-image.png') }}" alt="image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image">
                                            <img src="{{ asset('frontend/assets/images/shop/get-image2.png') }}" alt="image">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    <li class="marquee-item">
                        E-Cigarettes <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon"> <span>Vape Pens</span>
                        <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon">
                        Vape Juice <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon"> <span>E-Cigarettes</span>
                        <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon">
                        Vape Pens <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon"> <span>Vape Juice</span>
                        <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon">
                        E-Cigarettes <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon"> <span>Vape Pens</span>
                        <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon">
                        Vape Juice <img src="{{ asset('frontend/assets/images/icon/title-left.svg') }}" alt="icon"> <span>E-Cigarettes</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__image image">
                                <img src="{{ asset('frontend/assets/images/gallery/gallery-image1.jpg') }}" alt="image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            <div class="off-tag">50% <br>
                                off</div>
                            <div class="gallery__image image">
                                <img src="{{ asset('frontend/assets/images/gallery/gallery-image2.jpg') }}" alt="image">
                            </div>
                            <div class="gallery__content">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            <div class="off-tag">50% <br>
                                off</div>
                            <div class="gallery__image image">
                                <img src="{{ asset('frontend/assets/images/gallery/gallery-image3.jpg') }}" alt="image">
                            </div>
                            <div class="gallery__content">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            <div class="off-tag">50% <br>
                                off</div>
                            <div class="gallery__image image">
                                <img src="{{ asset('frontend/assets/images/gallery/gallery-image4.jpg') }}" alt="image">
                            </div>
                            <div class="gallery__content">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            <div class="off-tag">50% <br>
                                off</div>
                            <div class="gallery__image image">
                                <img src="{{ asset('frontend/assets/images/gallery/gallery-image5.jpg') }}" alt="image">
                            </div>
                            <div class="gallery__content">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand1.png') }}" alt="icon">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand2.png') }}    " alt="icon">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand3.png') }}" alt="icon">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand4.png') }}" alt="icon">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand5.png') }}" alt="icon">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand__item bor radius-10 text-center p-4">
                                <img src="{{ asset('frontend/assets/images/brand/brand6.png') }}" alt="icon">
                            </div>
                        </div>
                    </div>
                </div>
